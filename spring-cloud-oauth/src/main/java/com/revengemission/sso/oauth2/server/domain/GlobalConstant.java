...
public class GlobalConstant {
    ...
    public final static int ERROR                     = 0; // 返回失败
    public final static int SYSTEM_ERROR              = -1; // 系统错误
    ...
    public static final String MESSAGE_REQUEST_SUCCESS            = "request success";
    ...
    public static final String MESSAGE_APP_EXCEPTION              = "application exception";
}
